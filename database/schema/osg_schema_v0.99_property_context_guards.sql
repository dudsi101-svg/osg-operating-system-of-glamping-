...
-- All helper lookups are explicitly tenant-scoped.

-- -----------------------------------------------------------------
-- Helpers
-- -----------------------------------------------------------------
create or replace function osg_reservation_property(p_organization_id uuid, p_reservation_id uuid)
...
create or replace function osg_reservation_item_property(p_organization_id uuid, p_reservation_item_id uuid)
returns uuid language sql stable as $$
...
create or replace function osg_stay_property(p_organization_id uuid, p_stay_id uuid)
returns uuid language sql stable as $$
  select r.property_id
  from stay s
