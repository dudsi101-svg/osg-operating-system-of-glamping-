-- Glamping Nad Stawem — PropertyStayPolicy fixture v0.97
...
insert into property_stay_policy (
  ...
  default_checkin_time, default_checkout_time, readiness_buffer, active
) values (
...
-- IMPORTANT:
-- 15:00/11:00 are reference fixtures, not asserted production facts.
