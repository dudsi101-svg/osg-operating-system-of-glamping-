...
-- NOTE: allocation 001624 intentionally exercises tenant FK validation.
-- Its property_id MUST be corrected to the GNS property before posting.
update allocation
set property_id='00000000-0000-7000-8000-000000000010'
where id='00000000-0000-7000-8000-000000001624';
